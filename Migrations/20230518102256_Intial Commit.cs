        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VacationName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequedstVacationId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacationPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VacationPlans_RequestVacations_RequedstVacationId",
                        column: x => x.RequedstVacationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VacationPlans_RequedstVacationId",
                table: "VacationPlans",
                column: "RequedstVacationId");
        }
